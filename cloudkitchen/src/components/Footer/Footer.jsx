      ...
      <div className={styles.bookStrip}>
        <div className={styles.bookStripContent}>
          <div className={styles.bookStripText}>
            ...
            <p className={styles.bookStripSub}>Mon – Sat: 10:00 AM – 10:00 PM (Closed Sun)</p>
          </div>
          <a
      ...
      <div className={styles.body}>
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                ...
                <span className={styles.logoTagline}>Aesthetic Salon &amp; Clinic · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled near Union Metro Station in Al Rigga, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <address className={styles.contactText}>
                  119 A Street Exit-1<br />
                  near Union Metro, Al Rigga<br />
                  Deira, Dubai, UAE
                </address>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+971588989220" className={styles.contactLink}>+971 58 898 9220</a>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <div className={styles.contactText}>
                  <strong className={styles.hoursTitle}>Mon – Sat</strong>
                  <span>10:00 AM – 10:00 PM (Closed Sun)</span>
                </div>
              </div>
            </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Zang+Beauty+119+A+Street+Al+Rigga+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Zang Beauty Dubai. All rights reserved.
          </p>
