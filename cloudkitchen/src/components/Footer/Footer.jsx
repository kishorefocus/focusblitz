      ...
      <div className={styles.bookStrip}>
        <div className={styles.bookStripContent}>
          <div className={styles.bookStripText}>
            ...
            <p className={styles.bookStripSub}>Open Daily: 10:00 AM – 11:00 PM</p>
          </div>
          <a
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                <span className={styles.logoName}>Beauty &amp; Sense Ladies Salon</span>
                <span className={styles.logoTagline}>Beauty Parlour · Al Mamzar · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled on 54 Street, Al Mamzar, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+971564959101" className={styles.contactLink}>+971 56 495 9101</a>
              </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Beauty+and+Sense+Ladies+Salon+54+Street+Al+Mamzar+Deira+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Beauty &amp; Sense Ladies Salon. All rights reserved.
          </p>
