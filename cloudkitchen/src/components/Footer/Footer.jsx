      ...
      <div className={styles.body}>
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <address className={styles.contactText}>
                  Al Zarooni Building, Office 203<br />
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+971551088584" className={styles.contactLink}>+971 55 108 8584</a>
              </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Primera+Beauty+Salon+Al+Zarooni+Building+Al+Rigga+Road+Deira+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Primera Beauty Salon. All rights reserved.
          </p>
