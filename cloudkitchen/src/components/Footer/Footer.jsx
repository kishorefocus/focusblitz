      ...
      <div className={styles.bookStrip}>
        <div className={styles.bookStripContent}>
          <div className={styles.bookStripText}>
            ...
            <p className={styles.bookStripSub}>Open Daily: 10:00 AM – 10:00 PM</p>
          </div>
          <a
            href="https://wa.me/971525512838"
            target="_blank"
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                <span className={styles.logoName}>Diamond International Beauty</span>
                <span className={styles.logoTagline}>Beauty Parlour · Port Saeed · Deira · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled in Deira House Building on Abu Baker Al Siddique St, Port Saeed, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <address className={styles.contactText}>
                  Deira House Building, Shop 2<br />
                  Abu Baker Al Siddique St, Port Saeed<br />
                  Deira, Dubai, UAE
                </address>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+971525512838" className={styles.contactLink}>+971 52 551 2838</a>
              </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Diamond+International+Beauty+Deira+House+Abu+Baker+Al+Siddique+Street+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Diamond International Beauty. All rights reserved.
          </p>
