      ...
      <div className={styles.bookStrip}>
        <div className={styles.bookStripContent}>
          <div className={styles.bookStripText}>
            ...
            <p className={styles.bookStripSub}>Open Daily: 12:00 PM – 12:00 AM</p>
          </div>
          <a
      ...
      <div className={styles.body}>
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                ...
                <span className={styles.logoTagline}>Beauty Parlour · Deira · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled in Swissôtel Al Ghurair on Omar Bin Al Khattab Street, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <address className={styles.contactText}>
                  Swissôtel Al Ghurair, 5th Floor<br />
                  Omar Bin Al Khattab St, Al Muraqqabat<br />
                  Deira, Dubai, UAE
                </address>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+971509391092" className={styles.contactLink}>+971 50 939 1092</a>
              </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Porto+De+Belleza+Swissotel+Al+Ghurair+Omar+Bin+Al+Khattab+Street+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Porto De Belleza. All rights reserved.
          </p>
