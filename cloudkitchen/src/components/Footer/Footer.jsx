        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                <span className={styles.logoName}>Desert Wave Ladies Salon Dubai</span>
                <span className={styles.logoTagline}>Beauty Parlour · Al Muraqqabat · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled on 26B Street, Al Muraqqabat, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+97148866167" className={styles.contactLink}>+971 4 886 6167</a>
              </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Desert+Wave+Ladies+Salon+26B+Street+Al+Muraqqabat+Deira+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Desert Wave Ladies Salon Dubai. All rights reserved.
          </p>
