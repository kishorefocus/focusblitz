      ...
      <div className={styles.bookStrip}>
        <div className={styles.bookStripContent}>
          <div className={styles.bookStripText}>
            ...
            <p className={styles.bookStripSub}>Tue – Sun: 9:30 AM – 10:30 PM (Closed Mon)</p>
          </div>
          <a
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                <span className={styles.logoName}>Pinas Spa &amp; Beauty Center</span>
                <span className={styles.logoTagline}>Beauty Parlour · Al Rigga · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled on Al Rigga Street, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <address className={styles.contactText}>
                  Al Owais Building, Block E<br />
                  Shop #2-1 — Al Rigga Street<br />
                  Deira City, Dubai, UAE
                </address>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+97142621888" className={styles.contactLink}>+971 4 262 1888</a>
              </div>
              ...
              <div className={styles.contactItem}>
                ...
                <div className={styles.contactText}>
                  <strong className={styles.hoursTitle}>Tue – Sun</strong>
                  <span>9:30 AM – 10:30 PM (Closed Mon)</span>
                </div>
              </div>
            </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Pinas+Spa+and+Beauty+Center+Al+Owais+Building+Al+Rigga+Street+Deira+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Pinas Spa &amp; Beauty Center. All rights reserved.
          </p>
