        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <div>
                <span className={styles.logoName}>Sibs Style Beauty Lounge</span>
                <span className={styles.logoTagline}>Beauty Parlour · Muteena · Dubai</span>
              </div>
            </div>

            <p className={styles.brandText}>
              A sanctuary of elegance nestled on Salah Al Din Street, Deira, Dubai.
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                ...
                <address className={styles.contactText}>
                  Al Hashar Building, Office 301<br />
                  Salah Al Din St (next to Crowne Plaza)<br />
              ...
              <div className={styles.contactItem}>
                ...
                <a href="tel:+971529063016" className={styles.contactLink}>+971 52 906 3016</a>
              </div>
            ...
            {/* Map Link */}
            <a
              href="https://maps.google.com/?q=Sibs+Style+Beauty+Lounge+Al+Hashar+Building+Salah+Al+Din+Street+Deira+Dubai"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {currentYear} Sibs Style Beauty Lounge L.L.C. All rights reserved.
          </p>
