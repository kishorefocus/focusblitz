    ...
    <section className={styles.about} id="about" aria-labelledby="about-heading">
      ...
      <div className={styles.imageWrap}>
        <div className={styles.imageInner}>
          <Image
            ...
            alt="Diamond International Beauty interior — Dubai"
            fill
      ...
      <div className={styles.content}>
        ...
        <p className={styles.lead}>
          Welcome to Diamond International Beauty — where artistry meets indulgence. Nestled
          in Deira House Building on Abu Baker Al Siddique St, Port Saeed, we have been the destination of choice for
