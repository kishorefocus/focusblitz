    ...
    <>
      ...
      >
        <div className={styles.inner}>
          ...
          {/* ── Logo ── */}
          <Link href="#home" className={styles.logo} aria-label="Pinas Spa and Beauty Center">
            <span className={styles.logoMark}>✦</span>
            <div className={styles.logoText}>
              <span className={styles.logoName}>Pinas Spa</span>
              <span className={styles.logoSub}>Beauty Center</span>
            </div>
          </Link>
