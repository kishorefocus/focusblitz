    ...
    <>
      ...
      >
        <div className={styles.inner}>
          ...
          {/* ── Logo ── */}
          <Link href="#home" className={styles.logo} aria-label="Kim's Beauty Salon">
            <span className={styles.logoMark}>✦</span>
            <div className={styles.logoText}>
              <span className={styles.logoName}>Kim&apos;s Beauty</span>
              <span className={styles.logoSub}>Salon · Dubai</span>
            </div>
          </Link>
