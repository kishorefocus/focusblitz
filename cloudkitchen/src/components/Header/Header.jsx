    ...
    <>
      ...
      >
        <div className={styles.inner}>
          ...
          {/* ── Logo ── */}
          <Link href="#home" className={styles.logo} aria-label="Sibs Style Beauty Lounge L.L.C.">
            <span className={styles.logoMark}>✦</span>
            <div className={styles.logoText}>
              <span className={styles.logoName}>Sibs Style</span>
              <span className={styles.logoSub}>Beauty Lounge</span>
            </div>
          </Link>
