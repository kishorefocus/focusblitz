...
const steps = [
  {
    code: 'PHASE_01',
    title: 'Source',
    desc: 'Fresh, locally-sourced organic ingredients from vetted Bengaluru cooperatives — farm to cloud kitchen daily.',
  },
  {
    code: 'PHASE_02',
    title: 'Craft',
  ...
  },
  {
    code: 'PHASE_04',
    title: 'Deliver',
    desc: 'Drone-synchronized delivery to your coordinates in under 35 minutes, anywhere in the Yelahanka radius.',
  },
];
...
const faqs = [
  {
    ...
    a: 'We cover a 15km radius from our Yelahanka node. Standard ETA is 30–45 minutes depending on order volume.',
  },
  {
  ...
  },
  {
    ...
    a: 'Absolutely. Our masala formulas are multi-generational Odia and Karnataka recipes, precision-replicated with modern kitchen tech.',
  },
  {
...
const chefs = [
  {
    id: '01',
    name: 'DevAnsh Kar',
    role: 'Lead Masala Synthesizer',
    bio: 'Trained under traditional Odia culinary masters. 15+ years calibrating spice ratios and thali combos for maximum comfort-factor.',
    stats: [
      { k: 'MASALA_XP', v: 'LV.99' },
      { k: 'TEMP_CTRL', v: 'OPTIMAL' },
      { k: 'SEAFOOD', v: '94%' },
    ],
  },
  {
    id: '02',
    name: 'Chef Rajan',
    role: 'Thermal Grid Engineer',
    bio: 'Expert in high-temperature dal fry dynamics and chapati moisture retention. Zero-compromise on freshness protocols.',
    stats: [
      { k: 'CHAPATI_XP', v: 'LV.88' },
      { k: 'DAL_FRY', v: 'ELITE' },
      { k: 'SPEED', v: '99%' },
    ],
  },
      ...
      <section id="contact" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '32px' }}>
            {[
              { label: '📍 ADDRESS', lines: ['Gurukrupa Garden, Balaji Layout,', 'Janata Colony, Amrutahalli,', 'Yelahanka, Bengaluru 560092'] },
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{
            ...
            <span style={{ fontFamily: '"Barlow Condensed", sans-serif', fontWeight: 900, fontSize: '12px', color: '#000' }}>DA</span>
          </div>
          <span style={{
            fontFamily: 'var(--font-roboto-mono), monospace',
            ...
            © {new Date().getFullYear()} DEVANSH CLOUD KITCHEN [NODE_080]
          </span>
        </div>
